  ...
  const generateCode = async () => {
    try {
      const response = await axios.post(
        "http://localhost:8080/reservation-service/code/generateCode"
      );
  ...
  const handleBoughtCode = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8060/reservation-service/code/get-link-to-code"
      );
      ...
      <div className="create-salon">
        ...
        <div className="code-section">
          <div className="code-buttons">
            ...
            <button
              type="button"
              onClick={handleBoughtCode}
              className="bought-code-button"
            >
              Bought Code
            </button>
          </div>
